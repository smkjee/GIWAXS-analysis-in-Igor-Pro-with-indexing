...
//	wave/Z Radius2DWave=root:Packages:Convert2Dto1D:Radius2DWave
	...
	if (!WaveExists(Qvector) || !WaveExists(HistogramWv) || !WaveExists(LUT))
		NI1A_Create2DQWave(DataWave)			//creates 2-D Q wave does not need to be run always... //eliot changing June 2015
		NVAR UseGrazingIncidence=root:Packages:Convert2Dto1D:UseGrazingIncidence
		if(UseGrazingIncidence)
			GI_ReHistImage()
		else
		...
		//NI1A_CreateQvector(orientation)				//creates 2-D Q wave does not need to be run always... //eliot changing June 2015
...
Function NI1A_PopMenuProc(ctrlName,popNum,popStr) : PopupMenuControl
	...
	if(cmpstr(ctrlName,"LineProf_CurveType")==0)
		...
		checkbox LineProf_SubtractBackground,disable=(!stringMatch(KnWCT,"Ellipse")), win=NI1A_Convert2Dto1DPanel	
...
//				string Oldnote=""
			...
			//	NI1A_PrepareLogDataIfWanted(DataWaveName)		//creates the DataWaveNameDis wave...
				if(!silentmode)
					...
					if(thisisfirsttime)
						thisisfirsttime=0
						NI1A_Create2DQWave(CCDImageToConvert) // eliot adding this
					endif
				endif
...
//tab 6 output conditions
	...
	CheckBox LineProf_SubtractBackground,pos={110,330},size={90,14},title="Background Subtract?", mode=0, proc=NI1A_CheckProc
...
//Button SlicingButton,pos={170,627},size={120,18},proc=SlicingPanel ,title="Slice sel. file", font="Times New Roman",fSize=11
	...
	Slider ImageRangeMin,pos={15,647},size={150,16},proc=NI1A_MainSliderProc,variable= root:Packages:Convert2Dto1D:ImageRangeMin,live= 0,side= 1,vert= 0,ticks= 0
	...
	Slider ImageRangeMax,pos={15,663},size={150,16},proc=NI1A_MainSliderProc,variable= root:Packages:Convert2Dto1D:ImageRangeMax,live= 0,side= 1,vert= 0,ticks= 0
...
// tab 6 controls, GI geometry
	...
	CheckBox LineProf_SubtractBackground,disable=(tabNum!=6||!UseLineProfile||!stringMatch(KnWCT,"Ellipse")), win=NI1A_Convert2Dto1DPanel
...
Function NI1G_AddQAxisToImage(UseGrids)
	variable UseGrids
		...
		if(UseGrazingIncidence)
			...
			NI1A_Create2DQWave(root:packages:Convert2Dto1D:CCDImageToConvert)
		endif
